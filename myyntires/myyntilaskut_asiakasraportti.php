<?php
	...
	if ($tee == "") {
		...
		function laskeMaksunopeus($ytunnus, $yhtio) {
			...
			$html .= "".t("Myˆh‰ss‰ maksettuja laskuja").": ";
...
*/
				...
				echo "<th valign='top'><a href='$PHP_SELF?tunnus=$tunnus&tila=$tila&valintra=$valintra&valuutassako=$valuutassako&savalkoodi=$savalkoodi&ojarj=2".$ulisa."'>".t("Er‰p‰iv‰")."</a></th>";
				...
				echo "<th valign='top'><a href='$PHP_SELF?tunnus=$tunnus&tila=$tila&valintra=$valintra&valuutassako=$valuutassako&savalkoodi=$savalkoodi&ojarj=7".$ulisa."'>".t("Ik‰")."</a></th>";
				...
				EI TAIDA OLLA IHAN TOIMIVA TƒMƒ HAARA?
