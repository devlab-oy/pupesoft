<?php
	...
	if ($tee == "YHTEENVETO") {
		...
		if ($try == 'KAIKKI') {
			echo "<th nowrap><a href='$PHP_SELF?toim=$toim&tee=YHTEENVETO&nayta_valinta=$nayta_valinta&saapumispvm=$saapumispvm&lisatiedot=$lisatiedot$ulisa&order=".$orderurl."try'>".t("Ryhm‰")."</a><br>&nbsp;</th>";
		}
