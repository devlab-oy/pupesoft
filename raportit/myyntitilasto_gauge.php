<?php
	...
	if ($tee == 'laske') {
		...
		echo "<tr class='aktiivi'>";
		echo "<th class='toggleable' id='yhteensa_kustp'><img style='float:left;' id='img_yhteensa_kustp' src='{$palvelin2}pics/lullacons/bullet-arrow-right.png' />&nbsp;",t("Yhteensä"),"</th>";
		...
		foreach ($yhteensa_osasto as $osasto => $vals) {
			...
			echo "<th>",t("Yhteensä")," {$_osasto} ",t_avainsana("OSASTO", "", "and avainsana.selite ='{$osasto}'", "", "", "selitetark"),"</th>";
