...
if ($tee == 'DM') {
  ...
  if (mysql_num_rows($result) == 0) {
    ...
    echo "<thead>
        ...
        <th valign='top'>".t("Eräpvm")." / ".t("Maksupvm")."</th>
    ...
    echo "<tr><th colspan='3'>".t("Kaikki")." ".t("laskut")." ".t("yhteensä")."</th><td valign='top' align='right'>".sprintf('%.2f', $summa)." $yhtiorow[valkoodi]</td></tr>";
