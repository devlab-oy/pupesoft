  ...
  if (mysql_num_rows($res) > 0) {
    ...
    while ($row = mysql_fetch_assoc($res)) {
      ...
      $query = "SELECT
                ...
                sum(if (tilausrivi.laskutettuaika >= '$vva1-$kka1-$ppa1' and tilausrivi.laskutettuaika <= '$vvl1-$kkl1-$ppl1' and lasku.campaign_id IS NOT NULL and lasku.campaign_id != 0 ,tilausrivi.kpl,0)) laskut_kampanja1,
                sum(if (tilausrivi.laskutettuaika >= '$vva2-$kka2-$ppa2' and tilausrivi.laskutettuaika <= '$vvl2-$kkl2-$ppl2' and lasku.campaign_id IS NOT NULL and lasku.campaign_id != 0 ,tilausrivi.kpl,0)) laskut_kampanja2,
                sum(if (tilausrivi.laskutettuaika >= '$vva3-$kka3-$ppa3' and tilausrivi.laskutettuaika <= '$vvl3-$kkl3-$ppl3' and lasku.campaign_id IS NOT NULL and lasku.campaign_id != 0 ,tilausrivi.kpl,0)) laskut_kampanja3,
                sum(if (tilausrivi.laskutettuaika >= '$vva4-$kka4-$ppa4' and tilausrivi.laskutettuaika <= '$vvl4-$kkl4-$ppl4' and lasku.campaign_id IS NOT NULL and lasku.campaign_id != 0 ,tilausrivi.kpl,0)) laskut_kampanja4,
