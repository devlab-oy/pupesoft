		...
		foreach ($tilkpl as $yht_i => $kpl) {
			...
			if ((float) $kpl > 0 or ($kukarow["extranet"] == "" and (float) $kpl < 0) or ($yhtiorow['reklamaation_kasittely'] == 'U' and $toim == 'EXTRANET_REKLAMAATIO' and (float) $kpl !=0)) {
				...
				if (mysql_num_rows($tuoteres) == 0) {
					...
					if (($verkkokauppa != "" and $verkkokauppa_saldotsk === FALSE) or $laskurow["tilaustyyppi"] == "E" or ($laskurow["tilaustyyppi"] == "T" and $laskurow["tila"] == "T") or $laskurow["tilaustyyppi"] == "0" or $laskurow["tila"] == "V") {
						$varataan_saldoa = "EI";
					}
