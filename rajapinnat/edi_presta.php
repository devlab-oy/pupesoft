...
class EdiPresta {
  ...
  public static function create($sales_order, $filepath_base) {
    ...
    $edi_msg = "*IS from:721111720-1 to:IKH,ORDERS*id:{$sales_order['external_system_id']} version:AFP-1.0 *MS\n";
    $edi_msg .= "*MS {$sales_order['external_system_id']}\n";
    $edi_msg .= "*RS OSTOTIL\n";
    $edi_msg .= "NADSE:{$sales_order['yhtio_ovttunnus']}\n";
    $edi_msg .= "OSTOTIL.OT_NRO:{$sales_order['external_system_id']}\n";
    $edi_msg .= "OSTOTIL.OT_TILAUSTYYPPI:{$sales_order['tilaustyyppi']}";
    $edi_msg .= "OSTOTIL.VERKKOKAUPPA:\n";
    $edi_msg .= "OSTOTIL.OT_VERKKOKAUPPA_ASIAKASNRO:\n";
    ...
    $edi_msg .= "OSTOTIL.OT_ASIAKASNRO:{$sales_order['asiakasnro']}\n";
    ...
    $edi_msg .= "OSTOTIL.OT_TOIMITUS_NIMI:{$sales_order['toim_nimi']}\n";
    $edi_msg .= "OSTOTIL.OT_TOIMITUS_KATUOSOITE:{$sales_order['toim_osoite']}\n";
    $edi_msg .= "OSTOTIL.OT_TOIMITUS_POSTITOIMIPAIKKA:{$sales_order['toim_postitp']}\n";
    $edi_msg .= "OSTOTIL.OT_TOIMITUS_POSTINRO:{$sales_order['toim_postino']}\n";
    $edi_msg .= "OSTOTIL.OT_TOIMITUS_MAAKOODI:{$sales_order['toim_maa']}\n";
    ...
    foreach ($sales_order['tilausrivit'] as $tilausrivi) {
      ...
      $tilausrivi['sales_order_id'] = $sales_order['external_system_id'];
