...
if ($request['action'] == 'sync') {
  ...
  if (in_array('tuotteet', $synkronoi)) {
    ...
    $count = $magento_client->lisaa_simple_tuotteet($tuotteet);
  ...
  if (in_array('lajitelmatuotteet', $synkronoi)) {
    ...
    $lajitelmatuotteet = hae_lajitelmatuotteet();
  ...
  if (in_array('tuotekuvat', $synkronoi)) {
    ...
    $kuvat = hae_tuotekuvat();
    $count = $magento_client->lisaa_tuotekuvat($kuvat);
    echo date("d.m.Y @ G:i:s")." - Päivitettiin $count tuotekuvaa\n";
  }
