...
echo "<font class='head'>".t("Lisää ostolasku käsittelyjonoon")."</font><hr>";
...
if (is_uploaded_file($_FILES['userfile']['tmp_name']) === TRUE) {
  ...
  if (rename($_FILES['userfile']['tmp_name'], $dir."/".$_FILES['userfile']['name'])) {
    echo "<br>".t("Lasku").": ".$_FILES['userfile']['name']." ".t("siirretty käsittelyjonoon")."!<br><br>";
  }
  else {
    echo "<font class='error'>".t("Laskua ei voitu tallentaa käsittelyjonoon")."!</font>";
  }
}
