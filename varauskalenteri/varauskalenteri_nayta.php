...
echo "<tr><th>Lisätiedot:</th><td><pre>$row[kentta05]</pre></td></tr>";
echo "<tr><th>Isännät:</th><td><pre>$row[kentta06]</pre></td></tr>";
echo "<tr><th>Vieraat:</th><td><pre>$row[kentta07]</pre></td></tr>";
echo "<tr><th>Vieraslukumäärä:</th><td><pre>$row[kentta08]</pre></td></tr>";
