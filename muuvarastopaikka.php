<?php
	...
	if ($tee == 'MUUTA') {
		...
		//Kun tuotteen statusta muutetaa, poistetaan tuotteelta myˆs automaattisesti perustetut tuotepaikat. Manuaalisesti perustettuja tuotepaikkoja ei haluta poistaa.
			...
			foreach ($poistettavat as $poistettava) {
				...
				elseif ($saldot[$poistetaan] != 0) {
					...
					if (in_array($poistettava['hylly'], $kaikki_oletuspaikat)) {
						//katsotaan onko poistettava paikka automaattisesti generoitu vai manuaalisesti lis‰tty. Jos poistettava paikka on manuaalisesti lis‰tty niin sit‰ ei poisteta
						//jos paikka lˆytyy $try_status_kohtaiset_oletuspaikat niin se voidaan poistaa
