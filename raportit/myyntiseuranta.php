  ...
  if (isset($tee) and $tee == "lataa_tiedosto") {
    ...
    if ($lopetus == "") {
      ...
      echo "<table>
        ...
        <tr><td class='spec'>".t("N‰yt‰ yhteyshenkilˆiden tiedot (Vain Excel)").":</td><td><input type='checkbox' name='ytun_yhteyshenk' value='yhteyshenkilot' {$ytun_yhteyshenkchk}></td></tr>
        </table>
        </tr>
        <tr>
            ...
            if (isset($worksheet)) {
              ...
              if (isset($ytun_yhteyshenk) and $ytun_yhteyshenk != '') {
                ...
                for($i=0; $i<$maksimi_maara; $i++) {
                  $worksheet->write($excelrivi, $excelsarake++, ($i+1).'. Yhteyshenkilˆn nimi', $format_bold);
                  $worksheet->write($excelrivi, $excelsarake++, ($i+1).'. Yhteyshenkilˆn rooli', $format_bold);
                  $worksheet->write($excelrivi, $excelsarake++, ($i+1).'. Yhteyshenkilˆn nimitarkennekenne', $format_bold);
                  $worksheet->write($excelrivi, $excelsarake++, ($i+1).'. Yhteyshenkilˆn osoiteite', $format_bold);
                  $worksheet->write($excelrivi, $excelsarake++, ($i+1).'. Yhteyshenkilˆn postinomero', $format_bold);
                  $worksheet->write($excelrivi, $excelsarake++, ($i+1).'. Yhteyshenkilˆn postitpimipaikka', $format_bold);
                  $worksheet->write($excelrivi, $excelsarake++, ($i+1).'. Yhteyshenkilˆn suoramarkkinointirkkinointi', $format_bold);
                  $worksheet->write($excelrivi, $excelsarake++, ($i+1).'. Yhteyshenkilˆn email', $format_bold);
                  $worksheet->write($excelrivi, $excelsarake++, ($i+1).'. Yhteyshenkilˆn fakta', $format_bold);
                  $worksheet->write($excelrivi, $excelsarake++, ($i+1).'. Yhteyshenkilˆn tilausyhteyshenkilohteyshenkilo', $format_bold);
                }
              }
