    ...
    if (count($vak_chk_array) > 0) {
      ...
      if ($vakit_eri_tilaukselle) {
        ...
        if (mysql_num_rows($vak_check_res) == 1) {
          ...
          echo "<br><font class='error'>" . t("VIRHE: Tämä toimitustapa ei salli VAK-tuotteita") .
               "! (" . implode(",", $vak_chk_array) . ")</font><br>";
          echo "<font class='error'>" .
               t("Toimitustavalle on valitti, että VAK-tuotteet siirretään omalle tilaukselleen, " .
                 "mutta valittu toimitustapa ei myöskään salli VAK-tuotteita") .
               "!</font><br><br>";
        }
      }
      elseif ($kukarow['extranet'] == '') {
