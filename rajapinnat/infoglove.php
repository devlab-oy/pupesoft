...
foreach ($keissit as $keissi) {
	...
	switch ($keissi) {
		case "Asiakas" :
			$query =	"SELECT asiakas.selaus AS asiakasnro, asiakas.nimi, asiakas.ryhma, avainsana.selitetark, asiakas.maa, asiakas.konserni, asiakas.kustannuspaikka, kustannuspaikka.nimi
						FROM asiakas
