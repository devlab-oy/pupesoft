<?php
	...
	echo "<tr>";
	echo "<th>".t("Syˆt‰ tai valitse tuotemyyj‰").":</th>";
	...
	echo "<option value=''>".t("Tuotemyyj‰")."</option>";
	...
	echo "<tr>";
	echo "<th>".t("Syˆt‰ tai valitse tuoteostaja").":</th>";
	...
	echo "<tr>";
	echo "<th>".t("Syˆt‰ tai valitse tuotemalli").":</th>";
