...
if (isset($tee) and ($tee == "GENEROI" or $tee == "NAYTATILAUS") and $laskunumerot != '') {
  ...
  elseif ($tee == "NAYTATILAUS") {
    ...
    elseif ($yhtiorow["verkkolasku_lah"] == "fitek" and file_exists(realpath($nimifinvoice))) {
      ...
      echo "<table>";
      echo "<tr><th>".t("Lähetä aineisto uudestaan Fitek:iin").":</th>";
      echo "<form method='post'>";
    ...
    elseif (in_array($yhtiorow["verkkolasku_lah"], array("trustpoint", "ppg", "sepa", "fitek")) and !file_exists(realpath($nimifinvoice))) {
