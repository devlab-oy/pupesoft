...
echo "
<body>
<div class='header'><h1>", t("SISÄÄNKIRJAUTUMINEN"), "</h1></div>";
...
if (isset($return['usea_yhtio']) and $return['usea_yhtio'] == 1) {
  ...
  echo "<tr><td>", t("Valitse yritys"), ":</td></tr>";
  ...
  echo t("Käyttäjätunnus");
  echo '<br><br>';
  echo "<input type='text' value='' name='user' size='15' maxlength='30'>";
  echo '<br><br>';
  echo t("Salasana");
  echo '<br><br>';
  echo "<input type='password' name='salasana' size='15' maxlength='30'>";
  ...
  echo "<br><br><input type='submit' class='button' value='", t("Sisään"), "'>";
  echo "</form>";
  echo "</div>";
