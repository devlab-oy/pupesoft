...
if ($tee == 'P') {
	...
	// tutkitaan ollaanko jossain toimipaikassa alv-rekisterˆity ja oteteaan niiden alv tilit
	...
	if ($tilitrow["toim_alv"] != "") {
		...
		// jos lˆytyy yks niin homma hyvin! (else tulee yhtiˆn takaa tosta ylh‰‰lt‰)
...
if ($tee == 'E' or $tee == 'F') {
	...
	if ($trow[0] != 'X') {
		...
		// Jos myyntilasku, niin onko sit‰ karhuttu?
		if ($trow['tila'] == 'U') {
