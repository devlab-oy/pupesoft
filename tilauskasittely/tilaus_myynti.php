...
if ($tee == '') {
	...
	if ($kukarow['extranet'] == '' and ($kukarow['kassamyyja'] == '' or $kukarow['saatavat'] == '1') and $laskurow['liitostunnus'] > 0 and ($kaytiin_otsikolla == "NOJOO!" or mysql_num_rows($numres) == 0) and ($toim == "RIVISYOTTO" or $toim == "PIKATILAUS" or $toim == "EXTRANET")) {
		...
		if ($ylikolkyt > 0) {
			...
			echo "	<table>
					<tr>$jarjlisa
					<td class='back' align = 'left'><font class='error'>".t("HUOM!!!!!! Asiakkaalla on yli 15 päivää sitten erääntyneitä laskuja, olkaa ystävällinen ja ottakaa yhteyttä myyntireskontran hoitajaan")."!!!!!<br></font>$menuset</td>
					</tr>
					<tr>$jarjlisa
					<td class='back'><hr></td>
					</tr>
