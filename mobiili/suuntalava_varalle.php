				...
				foreach ($suuntalavan_tuotteet as $_tun => $_maara) {
					...
					if (trim($_maara) != '') {
						...
						if (!is_numeric($_maara)) {
							$error['tuotteet'] = t("Määrä täytyy olla numeerinen!", $browkieli);
							$kaikki_ok = false;
							break;
						}
						...
						if ((int) ($_maara * 10000) <= (int) ($chk_varattu_row['varattu'] * 10000)) {
							$error['tuotteet'] = t("Syötetty määrä täytyy olla suurempi kuin alkuperäinen määrä!", $browkieli);
							$kaikki_ok = false;
							break;
						}
					}
