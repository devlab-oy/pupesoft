  ...
  if ((int) $kukarow["kesken"] > 0) {
    ...
    if ($rivilaskuri > 0) {
      ...
      if ($kukarow['hinnat'] != -1 and $toim != "SIIRTOTYOMAARAYS" and $toim != "VALMISTAVARASTOON") {
        ...
        elseif (isset($summa_rahtivapaa_vertailuun) and (float) $summa_rahtivapaa_vertailuun != 0) {
          $rahtivapaa_vertailu = yhtioval($summa_rahtivapaa_vertailuun, $laskurow["vienti_kurssi"]);
        }
        else {
