		...
		if ($muuttuiko == 'kylsemuuttu') {
			foreach ($poikkeamat as $poikkeamatilaus => $poikkeamatilausrivit) {
				...
				if (($laskurow["email"] != '' or $laskurow['lahete_email'] != '') and $laskurow["kerayspoikkeama"] == 0) {
					...
					// Tarkastetaan, halutaanko l‰hett‰‰ s‰hkˆposti vaihtoehtoiseen, lahete_email-kent‰ss‰ m‰‰riteltyyn s‰hkˆpostiosoitteeseen
					...
					$boob = mail($email, mb_encode_mimeheader("$yhtiorow[nimi] - ".t("Ker‰yspoikkeamat", $kieli), "ISO-8859-1", "Q"), $ulos, $header, "-f $yhtiorow[postittaja_email]");
