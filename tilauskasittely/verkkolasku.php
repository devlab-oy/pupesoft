<?php
	...
	if ($tee == "LASKUTA") {
		...
		if ($silent == "") {
			$tulos_ulos .= "<br><br>\n".t("Tehd‰‰n u-laskut ja factoring aineisto:")."<br>\n";
		}
		...
		if (count($ketjut) != 0) {
			...
			foreach ($ketjut as $tunnukset) {
				...
				//jos maksuehdolla on factoring t‰pp‰ trigattu
				...
				if (($lasrow["vienti"] == "" or ($lasrow["vienti"] == "E" and $lasrow["chn"] == "020")) and
					...
					if ($masrow["factoring"] != '') {
						$laskunkommentit .= "VÂr fordran enligt denna faktura har ˆverlÂtits till S E B Finans AB (publ).";
						//t‰m‰ merkki | eli pystyviiva on rivinvaihdon merkki elmalla
						$laskunkommentit .= "|";
						$laskunkommentit .= "Fakturan skall d‰rfˆr betalas direkt till S E B Finans AB(publ), 167 81  BROMMA.";
					}
		...
		if ($lask > 0) {
			...
			//siirret‰‰n factoring aineisto factorointiyhtiˆlle
			...
			elseif($silent == "") {
				$tulos_ulos .= t("Factoring aineistoa ei l‰hetetty")."!<br>\n";
			}
