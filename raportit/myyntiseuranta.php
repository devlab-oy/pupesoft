    ...
    if ($tee == 'go') {
      ...
      foreach ($apu as $i => $mukaan) {
        ...
        if ($mukaan == "asiakasryhma") {
          ...
          $_parametrit["group_by"][] = "asiakasryhm‰";
          $_parametrit["order_by"][] = "asiakas.ryhma";
          $_parametrit["select"][] = "asiakasryhm‰";
        ...
        if ($mukaan == "asiakasmyyja") {
          ...
          $_parametrit["select"][] = "asiakasmyyj‰";
