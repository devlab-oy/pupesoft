...
if ($luokka != "") {
  ...
  echo "<th nowrap><a href='$PHP_SELF?toim=$toim&tee=LUOKKA&luokka=$luokka$ulisa&saapumispvm=$saapumispvm&lisatiedot=$lisatiedot&order=try&status=$status&sort=asc$ulisa2'>".t("Ryhmä")."</a><br>&nbsp;</th>";
  ...
  if (!$asiakasanalyysi and $lisatiedot == "TARK") {
    ...
    echo "<th nowrap><a href='$PHP_SELF?toim=$toim&tee=LUOKKA&luokka=$luokka$ulisa&saapumispvm=$saapumispvm&lisatiedot=$lisatiedot&order=myyjanro&status=$status&sort=asc$ulisa2'>".t("Myyjä")."</a><br>&nbsp;</th>";
  ...
  echo "<th nowrap><a href='$PHP_SELF?toim=$toim&tee=LUOKKA&luokka=$luokka$ulisa&saapumispvm=$saapumispvm&lisatiedot=$lisatiedot&order=kpl&status=$status&sort=desc$ulisa2'>$myykusana<br>".t("määrä")."</a></th>";

  if ($lisatiedot == "TARK") {
    echo "<th nowrap><a href='$PHP_SELF?toim=$toim&tee=LUOKKA&luokka=$luokka$ulisa&saapumispvm=$saapumispvm&lisatiedot=$lisatiedot&order=myyntierankpl&status=$status&sort=desc$ulisa2'>$myykusana".t("erä")."<br>".t("määrä")."</a></th>";
    echo "<th nowrap><a href='$PHP_SELF?toim=$toim&tee=LUOKKA&luokka=$luokka$ulisa&saapumispvm=$saapumispvm&lisatiedot=$lisatiedot&order=myyntieranarvo&status=$status&sort=desc$ulisa2'>$myykusana".t("erä")."<br>$yhtiorow[valkoodi]</a></th>";
    echo "<th nowrap><a href='$PHP_SELF?toim=$toim&tee=LUOKKA&luokka=$luokka$ulisa&saapumispvm=$saapumispvm&lisatiedot=$lisatiedot&order=rivia&status=$status&sort=desc$ulisa2'>$myykusana<br>".t("rivejä")."</a></th>";
    echo "<th nowrap><a href='$PHP_SELF?toim=$toim&tee=LUOKKA&luokka=$luokka$ulisa&saapumispvm=$saapumispvm&lisatiedot=$lisatiedot&order=puuterivia&status=$status&sort=desc$ulisa2'>".t("Puute")."<br>".t("rivejä")."</a></th>";
  }
  ...
  if (!$asiakasanalyysi and $lisatiedot == "TARK") {
    echo "<th nowrap><a href='$PHP_SELF?toim=$toim&tee=LUOKKA&luokka=$luokka$ulisa&saapumispvm=$saapumispvm&lisatiedot=$lisatiedot&order=ostoerankpl&status=$status&sort=desc$ulisa2'>".t("Ostoerä")."<br>".t("määrä")."</a></th>";
    echo "<th nowrap><a href='$PHP_SELF?toim=$toim&tee=LUOKKA&luokka=$luokka$ulisa&saapumispvm=$saapumispvm&lisatiedot=$lisatiedot&order=ostoeranarvo&status=$status&sort=desc$ulisa2'>".t("Ostoerä")."<br>$yhtiorow[valkoodi]</a></th>";
    echo "<th nowrap><a href='$PHP_SELF?toim=$toim&tee=LUOKKA&luokka=$luokka$ulisa&saapumispvm=$saapumispvm&lisatiedot=$lisatiedot&order=osto_rivia&status=$status&sort=desc$ulisa2'>".t("Ostettu")."<br>".t("rivejä")."</a></th>";
