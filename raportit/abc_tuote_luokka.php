<?php
	...
	echo "<th nowrap><a href='$PHP_SELF?toim=$toim&tee=LUOKKA&luokka=$luokka&try=$try&osasto=$osasto&tuotemerkki=$tuotemerkki&order=nimitys&sort=asc$ulisa'>".t("Nimitys")."</a><br>&nbsp;</th>";
	...
	echo "<th nowrap><a href='$PHP_SELF?toim=$toim&tee=LUOKKA&luokka=$luokka&try=$try&osasto=$osasto&tuotemerkki=$tuotemerkki&order=tulopvm&sort=desc$ulisa'>".t("Tulopvm")."</a><br>&nbsp;</th>";
	...
	echo "<th nowrap><a href='$PHP_SELF?toim=$toim&tee=LUOKKA&luokka=$luokka&try=$try&osasto=$osasto&tuotemerkki=$tuotemerkki&order=kpl&sort=desc$ulisa'>".t("Myynti")."<br>".t("KPL")."</a></th>";
	...
	if (mysql_num_rows($res) == 0) {
		...
		while ($row = mysql_fetch_array($res)) {
			...
			echo "<td align='right' nowrap>".str_replace(".",",",sprintf('%.1f',$row["katepros"]))."</td>";
			...
			echo "<td align='right' nowrap>".str_replace(".",",",sprintf('%.1f',$row["varaston_kiertonop"]))."</td>";
			echo "<td align='right' nowrap>".str_replace(".",",",sprintf('%.1f',$row["kpl"]))."</td>";
			echo "<td align='right' nowrap>".str_replace(".",",",sprintf('%.1f',$row["myyntierankpl"]))."</td>";
			...
			echo "<td align='right' nowrap>".str_replace(".",",",sprintf('%.1f',$row["ostoerankpl"]))."</td>";
		...
		echo "<tr>";
		echo "<td colspan='6' class='spec'>Yhteensä:</td>";
		...
		echo "<td align='right' class='spec' nowrap>".str_replace(".",",",sprintf('%.1f',$ryhmakplyht))."</td>";
