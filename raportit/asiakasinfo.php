	...
	if($rajaus == "" or $rajaus == "ALENNUKSET") {
		...
		if ($asale!='' or $aletaulu!='' or $yhdistetty != "" or $tee == "eposti") {
			...
			if($aletaulu != "" or $tee == "eposti") {
				$tuotejoin = "	LEFT JOIN tuote ON tuote.yhtio=perusalennus.yhtio and tuote.aleryhma=perusalennus.ryhma and osasto != 0 and try != 0 and hinnastoon != 'E' and status != 'P'";
			...
			$query = "
						...
						(							
							...
							LEFT JOIN tuote ON tuote.yhtio=asiakasalennus.yhtio and tuote.tuoteno=asiakasalennus.tuoteno and hinnastoon != 'E' and status != 'P'
