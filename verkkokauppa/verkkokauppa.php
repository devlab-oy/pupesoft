	...
	elseif($nayta == "tilaushistoria") {
		...
		echo "<table width='800'>
			<tr>
				...
				<a href=\"javascript:ajaxPost('tilaushaku', 'verkkokauppa.php?tee=asiakastiedot&nayta=tilaushistoria&hakutapa=viitteet', 'selain', false, true);\">".t("Hae laskun viitteistä")."</a><br>
