...
elseif ($toim == "RESEPTI") {
  ...
  echo "<font class='error'>".t("Tuntematon toiminto")."</font><hr>";
  exit;
}
...
if (($hakutuoteno != '' or $isatuoteno != '') and $tee == "") {
  ...
  if (mysql_num_rows($result) == 1) {
    ...
    elseif (mysql_num_rows($result) == 1) {
      ...
      elseif ($toim == "LISAVARUSTE") {
        echo "<th>".t("Lisävarusteiden faktat")."</th>";
      }
      elseif ($toim == "OSALUETTELO") {
      ...
      while ($prow = mysql_fetch_array($res)) {
        ...
        elseif ($tunnus == $prow["tunnus"]) {
          ...
          if ($toim == "PERHE") {
            ...
            echo "<td><input type='text' name='alekerroin' size='10' value='$zrow[alekerroin]'></td>";
          }
          ...
          if ($toim == "RESEPTI") {
            ...
            echo "<option value='' $sel1>".t("Määrää kerrotaan vaihdettaessa isätuotteen pituutta/määrää (kpl2)")."</option>";
            echo "<option value='X' $sel2>".t("Määrää ei kerrota vaihdettaessa isätuotteen pituutta/määrää (kpl2)")."</option>";
            echo "</select>";
            echo "</td>";
          }
    ...
    // Haulla löytyi monta tuotetta
      ...
      while ($row = mysql_fetch_array($result)) {
        ...
        echo "<td>";
        echo "<a href='$PHP_SELF?toim=$toim&isatuoteno={$_isatuoteno}&hakutuoteno={$_isatuoteno}'>$row[isatuoteno]</a>";
        echo "</td>";
