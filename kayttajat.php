	...
	if ($tee == 'MUUTA') {
		...
		if (strlen($firname) > 0 and isset($submit_button)) {
			...
			if ($selkuka != "KOPSAAUUSI") {
				...
				echo "<option value='1' {$sel[1]}>",t("Tilaukset menevät suoraan toimitukseen"),"</option>";
				echo "<option value='2' {$sel[2]}>",t("Tilaukset pitää hyväksyä ennen toimitusta"),"</option>";
				echo "<option value='3' {$sel[3]}>",t("Tilaukset pitää hyväksyä ennen toimitusta, jos tilauksella on tuotteita ulkomaan varastoista (muuten menevät suoraan toimitukseen)"),"</option>";
