<?php
	...
	echo "<th nowrap><a href='$PHP_SELF?toim=$toim&tee=LUOKKA&luokka=$luokka&try=$try&osasto=$osasto&tuotemerkki=$tuotemerkki&order=tulopvm&sort=desc$ulisa'>".t("Tulopvm")."</a></th>";
