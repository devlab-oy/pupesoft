<?php
  ...
  if ($tee != '' and isset($painoinnappia)) {
    ...
    $query = "  SELECT
          ...
          if(tilausrivi.laskutettuaika >= '{$vva}-{$kka}-{$ppa}' and tilausrivi.laskutettuaika <= '{$vvl}-{$kkl}-{$ppl}', tilausrivi.rivihinta, 0) myyntiVA,
          if(tilausrivi.laskutettuaika >= '{$vva}-{$kka}-{$ppa}' and tilausrivi.laskutettuaika <= '{$vvl}-{$kkl}-{$ppl}', tilausrivi.kate, 0) kateVA,
          if(tilausrivi.laskutettuaika >= '{$edellisvuosi}-{$kka}-{$ppa}' and tilausrivi.laskutettuaika <= '{$edellisvuosi}-{$kkl}-{$ppl}', tilausrivi.rivihinta, 0) myyntiEDVA,
          if(tilausrivi.laskutettuaika >= '{$edellisvuosi}-{$kka}-{$ppa}' and tilausrivi.laskutettuaika <= '{$edellisvuosi}-{$kkl}-{$ppl}', tilausrivi.kate, 0) kateEDVA,
          if(tilausrivi.laskutettuaika >= '{$edellisvuosi}-01-01' and tilausrivi.laskutettuaika <= '{$edellisvuosi}-12-31', tilausrivi.rivihinta, 0) myyntiED,
          if(tilausrivi.laskutettuaika >= '{$edellisvuosi}-01-01' and tilausrivi.laskutettuaika <= '{$edellisvuosi}-12-31', tilausrivi.kate, 0) kateED,
          if(tilausrivi.laskutettuaika >= date_sub('{$vvl}-{$kkl}-{$ppl}', interval 12 month), tilausrivi.rivihinta, 0) myynti12,
          if(tilausrivi.laskutettuaika >= date_sub('{$vvl}-{$kkl}-{$ppl}', interval 12 month), tilausrivi.kate, 0) kate12
          FROM lasku
