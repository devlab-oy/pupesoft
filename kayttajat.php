  ...
  if ($tee == 'MUUTA') {
    ...
    if (strlen($firname) > 0 and isset($submit_button)) {
      ...
      if ($selkuka != "KOPSAAUUSI") {
        ...
        echo "<tr><th align='left'>",t("Valitse tuoteryhmät, joista käyttäjä saa myydä"),":</td>";
        echo "<td>";
        ...
        echo "</td><td class='back'>",t("Ilman rajausta saa myydä kaikista tuoteryhmistä"),"</td></tr>";
        ...
        if ($toim != 'extranet') {
          ...
          echo "<tr><th align='left'>",t("Näytetään var myyntitilauksella"),":</th>
              <td><select name='naytetaan_var_tilauksella'>
              <option value=''  {$sel1}>",t("Kyllä"),"</option>
