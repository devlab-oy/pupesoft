...
if ($crm_asiakastiedot) {
  $header = "y-tunnus;nimi;katuosoite;postinumero;postitoimipaikka;maa;s‰hkˆpostiosoite;puhelin;asiakasnumero;asiakasryhm‰ ja ryhm‰n selitys;maksuehto;toimitusehto;myyj‰n nimi tai myyj‰n numero;toimitusosoittee postitoimipaikka\n";
}
else {
