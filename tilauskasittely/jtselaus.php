						...
						if ($kokonaismyytavissa > 0 or $toimi == '' or $paikatlask > 0) {
							...
							if ($automaaginen == '') {
								...
								if ($tilaus_on_jo == "") {
									...
									if ($jtrow["jv"] != "") {
										echo "<br><br><font class='message'>".t("Jälkivaatimusasiakas")."!</font><br><br>";
									}
							...
							if ($oikeurow['paivitys'] == '1') {
								...
								if (($kokonaismyytavissa >= $jurow["jt"] or $jtrow["ei_saldoa"] != "")  and $perheok==0) {
									...
									if ($kukarow["extranet"] == "" and ($automaaginen == 'automaaginen' or $automaaginen == 'tosi_automaaginen')) {
										...
										if ($kukarow["extranet"] == "") {
											echo "<td valign='top' $class>$kokonaismyytavissa ".ta($kieli, "Y", $jtrow["yksikko"])."<br><font style='color:green;'>".t("Riittää kaikille")."!</font><br>";
								...
								elseif ($kukarow["extranet"] == "" and $kokonaismyytavissa >= $jtrow["jt"] and $perheok==0) {
									...
									elseif ($automaaginen == "") {
										echo "<td valign='top' $class>$kokonaismyytavissa ".ta($kieli, "Y", $jtrow["yksikko"])."<br><font style='color:yellowgreen;'>".t("Ei riitä kaikille")."!</font><br>";
								...
								elseif ($paikatlask > 0 and $automaaginen == '' and $kukarow['extranet'] == '') {
									...
									if ($suoratoim_totaali >= $jurow["jt"]) {
										echo "<td valign='top' $class><font style='color:green;'>".t("Riittää kaikille")."!$varalisa</font></td>";

									}
									elseif ($suoratoim_totaali >= $jtrow["jt"]) {
										echo "<td valign='top' $class><font style='color:yellowgreen;'>".t("Ei riitä kaikille")."!$varalisa</font></td>";
									}
									else {
								...
								elseif ($kukarow["extranet"] == "" and $kokonaismyytavissa > 0 and $perheok==0) {
									if ($automaaginen == '') {
										echo "<td valign='top' $class>$kokonaismyytavissa ".ta($kieli, "Y", $jtrow["yksikko"])."<br><font style='color:orange;'>".t("Ei riitä koko riville")."!</font><br>";
								...
								// Riviä ei voida toimittaa
									...
									if ($automaaginen == '') {
										echo "<td valign='top' $class>$kokonaismyytavissa ".ta($kieli, "Y", $jtrow["yksikko"])."<br><font style='color:red;'>".t("Riviä ei voida toimittaa")."!</font><br>";
