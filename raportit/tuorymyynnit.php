...
if ($ytunnus!='' and $try!='') {
	...
	echo "<br><font class='message'>".t("Osasto")." $osasto ".t("tuoteryhm‰")." $try ".t("myynti kausittain viimeiset 24 kk")." (<font color='$cmyynti'>".t("myynti")."</font>/<font color='$ckate'>".t("kate")."</font>/<font color='$ckatepr'>".t("kateprosentti")."</font>)</font><hr>";
	...
	while ($sumrow = mysql_fetch_array($result)) {
		...
		<td valign='bottom' align='center'><img src='../pics/green.png' height='$hkatepro' width='12' alt='".t("kateprosentti")." $sumrow[katepro] %'></td>
		</tr></table>";
		...
		echo "<tr><td nowrap align='right'><font class='info'><font color='$cmyynti'>$sumrow[kpl] ".t("kpl")."</font></font></td></tr>";
