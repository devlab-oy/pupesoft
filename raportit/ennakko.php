<?php
	...
	if (isset($tee) and $tee == "lataa_tiedosto") {
		...
		if (!isset($sel)) $sel = array();
		if (!isset($select_kieli)) $select_kieli = 'fi';
		if (!isset($select_laji)) $select_laji = array();
		if (!isset($submitnappi)) $submitnappi = '';
		...
		while ($laji_row = mysql_fetch_assoc($laji_result)) {
			if (in_array($laji_row['laji'], $select_laji)) $sel[$laji_row['laji']] = ' selected';
