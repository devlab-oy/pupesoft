...
if ($tee == '') {
	...
	if ((int) $kukarow["kesken"] != 0) {
		...
		//Oletetaan, että tilaus on ok, $tilausok muuttujaa summataa alempana jos jotain virheitä ilmenee
		$tilausok 		= 0;
		...
		if ($rivilaskuri != 0) {
			...
			//Jos myyjä on myymässä olkomaan varastoista liiabn pienellä summalla
			...
			if ($kukarow['extranet'] == '' and $arvo_ulkomaa != 0) {
				...
				echo "<tr>
					<td class='back' colspan='$ycspan'></td>
					<td class='back' colspan='4' align='right'>".t("Arvo yhteensä").":</td>
		...
		if ($estetaankomyynti == '' and $muokkauslukko == "" and $rivilaskuri == 0 and $laskurow["liitostunnus"] > 0 and $kukarow["kassamyyja"] == '' and $toim != "TYOMAARAYS" and $toim != "MYYNTITILI" and $toim != "TARJOUS") {
