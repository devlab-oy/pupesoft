<?php
		...
		if ($tuote_status != "P") {
			...
			if ($tuote_status != 'T') {
				...
				if (mysql_num_rows($result) == 0) {
					// Lisätään kauteen sata, että saadaan vuosiluvut täsmäämään budjetin kanssa (helpottaa koodia alla)
	...
	if (!isset($tee) or $tee == "") {
        ...
        echo "<option value='A' {$sel[$tilaustuotteiden_kasittely]}>".t("Tilaustuotteiden määräennuste on jälkitoimitusrivit")."</option>";
        echo "<option value='B' {$sel[$tilaustuotteiden_kasittely]}>".t("Tilaustuotteiden määräennuste on budjetti/myynti")."</option>";
        echo "<option value='C' {$sel[$tilaustuotteiden_kasittely]}>".t("Tilaustuotteiden määräennuste on jälkitoimitusrivit + budjetti/myynti")."</option>";
		echo "</select>";
		echo "</td>";
		echo "</tr>";
