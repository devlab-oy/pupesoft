				...
				while ($prow = mysql_fetch_array ($qresult)) {
					...
					if ($tapahtumalaji == "" or strtoupper($tapahtumalaji)==strtoupper($prow["laji"])) {
						...
						if ($prow["laji"] == "tulo" and $prow["lasku2tunnus"] != "") {
							echo "<br><a href='raportit/asiakkaantilaukset.php?toim=OSTO&tee=NAYTATILAUS&tunnus=$prow[lasku2tunnus]&lopetus={$palvelin2}tuote.php////tuoteno=$tuoteno//tee=Z'>".t("Näytä keikka")." $prow[lasku2laskunro]</a>";
						}
