<?php
	...
	if (!isset($from_kaikkikorj)) {
		...
		if ($tee == "VALMISTA" and $valmistettavat != "") {
			...
			if ($toim != 'KORJAA' and $toim != 'TUTKAA') {
				echo "<tr><td colspan='8'>",t("Valmista syˆtetyt kappaleet"),":</td><td><input type='submit' name='osavalmistus' id='osavalmistus' value='".t("Valmista")."'><input type='hidden' name='tulin' value='{$tulin}' /></td>$osavalmistus_force</tr>";
