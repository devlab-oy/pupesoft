<?php
	...
	if ($tee == 'M') {
		if ($kohdevarasto != '' and $lahdevarasto != '' and $kohdevarasto != $lahdevarasto) {
			...
			if ($lask == 0) {
				echo "<font class='error'>".t("Yhtään riviä ei voitu toimittaa lähdevarastosta kohdevarastoon")."!!!!</font>";
				...
				elseif ($kukarow['kesken'] != 0){
					echo "<font class='error'>".t("APUAAAA tilauksella $kukarow[kesken] on rivejä vaikka luultiin että ei olisi!!!!!")."<br></font>";
				}
