...
DELETE FROM avainsana WHERE yhtio = '{$kukarow['yhtio']}' AND laji = 'LAITE_TILA';
INSERT INTO `avainsana` (`yhtio`, `perhe`, `kieli`, `laji`, `nakyvyys`, `selite`, `selitetark`, `selitetark_2`, `selitetark_3`, `selitetark_4`, `selitetark_5`, `jarjestys`, `laatija`, `luontiaika`, `muutospvm`, `muuttaja`)
VALUES
	...
	if (!isset($yhtiorow['laite_huolto'])) {
		$query =	"ALTER TABLE yhtion_parametrit ADD COLUMN laite_huolto CHAR(1) NOT NULL DEFAULT '' AFTER vastaavat_tuotteet_esitysmuoto;
					UPDATE yhtion_parametrit SET laite_huolto = 'X' WHERE yhtio = '{$kukarow['yhtio']}';";
		pupe_query($query);
	}
...
VALUES
	...
	('', 'Sammutinhuolto', 'asiakkaan_laite_hallinta.php', '', '', '', 'Asiakkaan laitehallinta', 30, 0, '', '{$kukarow['yhtio']}', '', NOW(), NOW(), 'import'),
	('', 'Sammutinhuolto', 'yllapito.php', 'asiakas!!!TURVANASI!!!true', '', '', 'Asiakasylläpito', 40, 0, '', '{$kukarow['yhtio']}', '', NOW(), NOW(), 'import'),
...
VALUES
	...
	('Sammutinhuolto', 'Sammutinhuolto', 'yllapito.php', 'asiakas!!!TURVANASI!!!true', '1', '', 'Asiakasylläpito', 40, 0, 'Sammutinhuolto', '{$kukarow['yhtio']}', '', 'import', NOW(), NOW(), 'import'),
