...
if ($tee == 'Z') {
  ...
  if ($lisa == '') {
    ...
    if ($yhyllyalue == '' or $yhyllynro == '' or $yhyllyvali == '' or $yhyllytaso == '') {
      $tee = 'Y';
      $varaosavirhe = t("Sinun on annettava täydellinen osoite")."<br>";
    }
  }
  ...
  if ($lisa == '') {
    ...
    if (mysql_num_rows($paikatres) > 0) {
      ...
      $tee = 'Y';
      $varaosavirhe = t("Alueväliltä ei löytynyt yhtään paikkaa!")."<br>";
    }
  }
  else {
    $paikat = array();
...
//tähän arrayhin pitää lisätä uusia malleja jos tehdään uusia inccejä ja ylempänä tehdä iffejä.
$pohjat=array();
$pohjat[]='Tec 80x20x4';
