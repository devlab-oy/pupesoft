  ...
  if (mysql_num_rows($result) > 0) {
    ...
    if ($sytunnus != '') {
      ...
      if ($ylivito > 0 and $eiliittymaa != 'ON') {
        echo "<br/>";
        echo "<font class='error'>".t("HUOM! Asiakkaalla on yli %s päivää sitten erääntyneitä laskuja, olkaa ystävällinen ja ottakaa yhteyttä myyntireskontran hoitajaan", $kukarow['kieli'], $pvmraja)."</font>";
        echo "<br/>";
      }
    }
