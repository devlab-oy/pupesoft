		...
		elseif ($tee == 'tuotteet') {
			...
			while ($row = mysql_fetch_assoc($result)) {
				...
				if ($row['plft'] == 1) {
					...
					if ($oikeus != '') {
						echo "\n<br /><a href='?toim=$toim&laji=$laji&ISI=".$row['node_nimi']."&tee=lisaa&plft=".$row['plft']."&subd=".$row['sub_dee']."'><img src='{$palvelin2}pics/lullacons/add.png' alt='",t('Lisää lapsikategoria'),"'/></a>";
						...
						echo "\n&nbsp;<a href='?toim=$toim&laji=$laji&ISI=".$row['node_nimi']."&tee=taso&plft=".$row['plft']."'><img src='{$palvelin2}pics/lullacons/folder-new.png' alt='",t('Lisää taso'),"'/></a>";
					}
					...
					if ($oikeus != '') {
						echo "\n<br /><a href='?toim=$toim&koodi=".$row['node_koodi']."&laji=$laji&ISI=".$row['node_nimi']."&tee=lisaa&plft=".$row['plft']."&subd=".$row['sub_dee']."'><img src='{$palvelin2}pics/lullacons/add.png' alt='",t('Lisää lapsikategoria'),"'/></a>";
					...
					if ($oikeus != '' and lapset($row['node_nimi'],$row['parent_lft'],$laji,$kukarow) > 0) {
						echo "\n&nbsp;<a href='?toim=$toim&koodi=".$row['node_koodi']."&laji=$laji&ISI=".$row['node_nimi']."&tee=taso&plft=".$row['plft']."'><img src='{$palvelin2}pics/lullacons/folder-new.png' alt='",t('Lisää taso'),"'/></a>";
					}
					echo "</td></tr>";
