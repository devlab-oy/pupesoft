    ...
    while ($prow = mysql_fetch_assoc($qresult)) {
      ...
      if ($tapahtumalaji == "" or strtoupper($tapahtumalaji) == strtoupper($prow["laji"])) {
        ...
        if ($prow["laji"] == "tulo" and $prow["lasku2tunnus"] != "") {
          ...
          $_return .= "<a name='$ankkuri' href='raportit/asiakkaantilaukset.php?toim=OSTO&tee=NAYTATILAUS&tunnus=$prow[lasku2tunnus]&lopetus=$tkysy_lopetus///$ankkuri'>".t("Näytä saapuminen")." $prow[lasku2laskunro]</a>";
        }
