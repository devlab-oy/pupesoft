...
echo "<a href='ostotilaus.php' class='button'><font color='chucknorris'>(".t("Jatka edellist�").")</font></a>";

echo "</li>";

echo "<li><a href='siirtolista.php?uusi' class='button'>", t("Siirtolista"), "</a>";

echo "<a href='siirtolista.php' class='button'><font color='chucknorris'>(".t("Jatka edellist�").")</font></a>";
