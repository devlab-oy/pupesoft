<?php
	...
	if (isset($tee) and $tee == "lataa_tiedosto") {
		...
		if ($submit_button != "" and ($tuoteno > 0 or $asiakasid > 0 or $toimittajaid > 0 or $lisa != "" or $lisa_parametri != "" or $lisa_dynaaminen != "" or $liitostunnukset != "") and is_array($tilikaudetrow)) {
			...
			function piirra_budj_rivi ($row, $tryrow = "") {
				...
				if ($toim == "TUOTE") {
					...
					$excelsarake++;
					echo "<tr><td>$row[tuoteno] $row[nimitys]</td>";
				}
