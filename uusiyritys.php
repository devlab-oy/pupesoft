<?php
	...
	//Jatka tasta. Uuden yrityksen oikeudet jutun setvimista.
	if ($tila == 'profiilit') {
	...
	if ($tila == 'profiilit') {
		...
		echo "<form action = '$PHP_SELF' method='post'>
				...
				<input type='hidden' name = 'fromyhtio' value='$fromyhtio'>
				<table>
				<tr><th>".t("Anna käyttäjätunnus").":</th><td><input type='text' name = 'kuka' value=''></td></tr>
				<tr><th>".t("Nimi").":</th><td><input type='text' name = 'nimi' value=''></td></tr>
				<tr><th>".t("Salasana")."</th><td><input type='text' name = 'salasana' value=''></td></tr>
