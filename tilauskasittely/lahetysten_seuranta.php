			...
			while ($row = mysql_fetch_assoc($res)) {
				...
				if (mysql_num_rows($era_res) > 0) {
					...
					while ($era_row = mysql_fetch_assoc($era_res)) {
						echo "<tr>";
						echo "<td class='sscc' id='{$era_row['sscc']}'>{$era_row['sscc']}<img title='",t("N‰yt‰ kollin sis‰ltˆ"),"' alt='",t("N‰yt‰ kollin sis‰ltˆ"),"' src='{$palvelin2}pics/lullacons/go-down.png' style='float:right;' /></td>";
