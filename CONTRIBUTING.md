...
* Käytä välilyöntiä kaikkien PHP [control structure](http://www.php.net/manual/en/language.control-structures.php) avainsanojen jälkeen. Esim. `if`, `while`, `for`, jne..
