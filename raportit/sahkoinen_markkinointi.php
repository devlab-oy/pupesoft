<?php
	/**
	create index yhtio_postinumero on asiakas (yhtio, postino);
	create index yhtio_postitp on asiakas (yhtio, postitp);
	create index yhtio_liitostunnus on asiakkaan_avainsanat (yhtio, liitostunnus);
	**/
	...
	if (isset($tee) and $tee == "lataa_tiedosto") {
		...
		echo "<tr>";
		echo "<td>".t("Alkaa")."</td><td><input type='text' name='pvm1' value='$pvm1' size='2'> <input type='text' name='kk1' value='$kk1' size='2'> <input type='text' name='vuosi1' value='$vuosi1' size='4'></td>";
		echo "</tr><tr>";
