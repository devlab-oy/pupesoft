...
// Jos lis‰t‰‰n/p‰ivitet‰‰n yhteyshenkilˆit‰ jotka on sidottu y-tunnukseen
if ($toim == "yhteyshenkilo" and $upd == '1' and $yhtiorow['yhteyshenkiloiden_sidos'] == 'Y') {

  // Onko lis‰tty uusi yhteyshenkilˆ vai p‰ivitet‰‰nkˆ vanhaa
  ...
  if (!empty($_REQUEST['tunnus']) and $_REQUEST['tunnus'] > 0) {    
    ...
    if ($yhenkrow['tunnus'] > 0 and $asiakasrow['tunnus']) {
      ...
      // lis‰t‰‰n tai p‰ivitet‰‰n yhteyshenkilˆ kaikille asiakkuuksille   
...
if ($tunnus > 0 or $uusi != 0 or $errori != '') {
  ...
  if (($toim == "asiakas" or $toim == "yhtio") and $uusi != 1) {
    ...
    if ($toim == "asiakas") {
      ...
      echo "<br><input type = 'checkbox' name='paivita_myos_kanavointitieto' value = 'OK'> ".t("P‰ivit‰ vain verkkolaskutunnus ja kanavointitieto avoimille tilauksille");
    }
  }
