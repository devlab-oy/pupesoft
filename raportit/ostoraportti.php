...
// Toimittaja ja asiakashaku
if (($tee == "" and isset($jatkanappi)) or $tee == "JATKA") {

  $tee = "JATKA";

  if (isset($muutparametrit)) {
    list($mul_osasto, $mul_try, $ytunnus, $mul_tme, $asiakasosasto, $asiakasno, $abcrajaus, $lisa, $lisa_parametri, $toimittaja) = explode("!¡!", $muutparametrit);
  ...
  $muutparametrit = urlencode(serialize($mul_osasto))."!¡!".urlencode(serialize($mul_try))."!¡!".$ytunnus."!¡!".urlencode(serialize($mul_tme))."!¡!".$asiakasosasto."!¡!".$asiakasno."!¡!".$abcrajaus."!¡!".$lisa."!¡!".$lisa_parametri."!¡!";
