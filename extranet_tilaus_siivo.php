...
if (!isset($argv[1]) or trim($argv[1]) == '') {
  echo "Ensimmäinen parametri yhtio!";
  exit(1);
}
...
if ($laskuri_jt > 0 or $laskuri_norm > 0) {
  ...
  echo ": Palautettiin $laskuri_jt jt-riviä alkuperäisille extranet-tilauksille";
  echo " ja $laskuri_norm tilausriviä ei enää varaa saldoa.\n";
}
