...
if (isset($tee) and $tee == "lataa_tiedosto") {
  ...
  if ($tee != "" and strtotime("{$avv}-{$akk}-{$app}") > strtotime("{$lvv}-{$lkk}-{$lpp}")) {
    echo "<font class='error'>",t("VIRHE: Alkupäivämäärä on suurempi kuin loppupäivämäärä"),"!</font><br />";
    $tee = "";
  }
  ...
  if ($tee == 'hae') {
    ...
    if (mysql_num_rows($laskures) == 0) {
      ...
      echo "<br /><font class='info'>",t("Yhtään tilausta ei löytynyt"),"!</font><br />";
