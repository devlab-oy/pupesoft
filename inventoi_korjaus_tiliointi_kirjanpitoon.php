...
$yhtiorow = mysql_fetch_assoc($row);

        ///* Luetaan tapahtuma *///
$query = "SELECT tapahtuma.*, lasku.tunnus as laskutunnus from tapahtuma 
              ...
              where tapahtuma.yhtio       =  '$kukarow[yhtio]'
                ...
                and tapahtuma.laadittu  > '2015-05-22'
  ...
  echo "tapahtuma: $tapahtumaid, $tapahtumarow[tuoteno], $tapahtumarow[laadittu], $tiliointisumma, $yhtiorow[varastonmuutos], $yhtiorow[varastonmuutos_inventointi]  \n";
              ...
              $tapvm = $tapahtumarow['laadittu'];  // date('Y-m-d');
