<?php
	...
	if ($tapa == "vienti" and $tee != "lista") {
		...
		if ($tee == 'K') {
			...
			echo "	<tr><td>6.  ".t("Kollim‰‰r‰").":</td>
					<td colspan='2'>$rahtirow[kollit]</td></tr>";

			echo "	<tr><td>17. ".t("M‰‰r‰maan koodi").":</td>
					<td colspan='2'><input type='text' name='maa_maara' size='2' value='$laskurow[maa_maara]'></td><td class='back'>".t("Pakollinen kentt‰")."</td></tr>";

			if ($laskurow["vienti"] == "K") {
				echo "	<tr><td>18. ".t("Sis‰maan kuljetusv‰line").":</td>
						...
						<td class='back'>Pakollinen kentt‰</td></tr>";

				echo "	<tr><td>26. ".t("Sis‰maan kuljetusmuoto").":</td>
				...
				echo "</select></td><td class='back'>".t("Pakollinen kentt‰")."</td>";
				echo "</tr>";
				...
				echo "	<tr><td>19. ".t("Kulkeeko tavara kontissa").":</td><td>".t("Kyll‰").": <input type='radio' name='kontti' value='1' $chk1></td>
						<td>Ei: <input type='radio' name='kontti' value='0' $chk2></td><td class='back'>".t("Pakollinen kentt‰")."</td></tr>";

				echo "	<tr><td>21. ".t("Aktiivisen kuljetusv‰lineen tunnus ja kansalaisuus").":</td>
						<td><input type='text' name='aktiivinen_kuljetus' size='25' value='$laskurow[aktiivinen_kuljetus]'></td>
						<td><input type='text' name='aktiivinen_kuljetus_kansallisuus' size='2' value='$laskurow[aktiivinen_kuljetus_kansallisuus]'></td><td class='back'>".t("Voidaan j‰tt‰‰ tyhj‰ksi jos asiakas t‰ytt‰‰")."</td></tr>";
			}
			...
			if ($laskurow["vienti"] == "K") {
				...
				echo "<option value = '##'>".t("Ole hyv‰ ja valitse")."";
				...
				echo "</select></td><td class='back'>".t("Pakollinen kentt‰")."</td></tr>";

				echo "	<tr><td>28. ".t("V‰hennett‰v‰ er‰, ulkomaiset kustannukset")."</td><td colspan='2'><input type='text' name='vahennettava_era' size='25' value='$laskurow[vahennettava_era]'></td></tr>";
				echo "	<tr><td>28. ".t("Toimitusehdon mukainen lis‰tt‰v‰ er‰")."</td><td colspan='2'><input type='text' name='lisattava_era' size='25' value='$laskurow[lisattava_era]'></td></tr>";
			}
	...
	if ($tee == '') {
		...
		echo "<tr>";
		echo "<th>";
		echo t("Syˆt‰ nimi")." / ".t("Laskunumero")." / ".t("Keikkanumero");
		echo "</th>";
		echo "<td>";
