  ...
  if ((int) $kukarow["kesken"] > 0) {
    ...
    if ($rivilaskuri > 0) {
      ...
      while ($row = mysql_fetch_assoc($result)) {
        ...
        if ($toim == "YLLAPITO") {
          echo "<br><br><a href='{$palvelin2}/laiterekisteri.php?toiminto=LINKKAA&tilausrivin_tunnus={$row['tunnus']}&sopimusnumero=$tilausnumero&lopetus={$palvelin2}tilauskasittely/tilaus_myynti.php////tilausnumero=$tilausnumero//toim=YLLAPITO'>Lisää laitteita</a>";
        }
