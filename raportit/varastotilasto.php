...
echo "<option value = 'kappaleet'{$sel['kappaleet']}>".t("Listauksessa näytetään myynti kappaleina")."</option>";
echo "<option value = 'hinnat'{$sel['hinnat']}>".t("Listauksessa näytetään myynti euroina")."</option>";
echo "<option value = 'kappaleet2'{$sel['kappaleet2']}>".t("Listauksessa näytetään myynti ja kulutus kappaleina")."</option>";
echo "</select>";
echo "</td>";
echo "</tr>";
...
if ($tee != "" and isset($painoinnappia)) {
  ...
  if ($total_rows > 0) {
    ...
    if ($total_rows <= 1000) {
      ...
      $varastotilasto_table .= "<th>".t("Tuoteryhmä")."</th>";
      ...
      $varastotilasto_table .= "<th>".t("Tilattu määrä")."</th>";
