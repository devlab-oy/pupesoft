...
if ($tee == 'tulosta') {
  ...
  if (mysql_num_rows($rakir_res) == 0) {
    ...
    foreach ($rakir_rows as $rakir_row) {
      ...
      pupesoft_log('toimitusvahvistus_email', "Ollaan menossa toimitusvahvistuksen lähetykseen? ({$rakir_row["toimitusvahvistus"]})");
      ...
      if ($rakir_row['toimitusvahvistus'] != '' and (!$_onko_unifaun or $_desadv)) {
        ...
        if (file_exists("tilauskasittely/$rakir_row[toimitusvahvistus]")) {
          ...
          pupesoft_log('toimitusvahvistus_email', "Päästiin reuire-iffistä läpi ({$rakir_row["toimitusvahvistus"]})");
