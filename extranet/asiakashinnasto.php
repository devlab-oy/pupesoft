	...
	if (isset($tee_lataa)) {
		...
		if ($tee != '' and $asiakas > 0 and isset($ajahinnasto)) {
			...
			if (isset($workbook)) {
				...
				$worksheet->writeString($excelrivi,  3, t("Tuoteryhm‰"), $format_bold);
				$worksheet->writeString($excelrivi,  4, t("Nimitys"), $format_bold);
				$worksheet->writeString($excelrivi,  5, t("Yksikkˆ"), $format_bold);
				$worksheet->writeString($excelrivi,  6, t("Aleryhm‰"), $format_bold);
