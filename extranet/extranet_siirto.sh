...
FILES="asiakkaan_laite_hallinta.php
extranet_tarjoukset_ja_ennakot.php
hinnasto.php
inc/asiakashaku.inc
inc/connect.inc
inc/footer.inc
...
tilauskasittely/poikkeamaraportti_pdf.php
tilauskasittely/pupesoft_ediout.inc
tilauskasittely/syotarivi.inc
tilauskasittely/tarkastuspoytakirja_pdf.php
