<?php
	...
	if ($_POST["pdf"] == 'GO' and $_POST["otunnus"] != '') {
		require "tilauskasittely/tulostakopio.php";
	}	
	else {
		...
		// Tositeselailu
		if ($tee == 'Y' or $tee == 'Z' or $tee == 'X' or $tee == 'W' or $tee == 'T' or $tee == 'S' or $tee == '≈') {

			if  ($tee == 'Z' or $tee == 'X' or $tee == 'W' or $tee == 'T' or $tee == 'S' or $tee == '≈') {
