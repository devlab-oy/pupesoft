<?php
	...
	echo "<tr><th>".t("Näytä vain ne joilla maksettavaa on yli").":</th><td valign='top'><input type='text' name='yli' size ='15' value='$yli'></td></tr>";
	...
	echo "</select></td><td valign='top' class='back'><input type='submit' value='".t("Näytä")."'></td><td valign='top' class='back'>".t("Jätä kaikki kentät tyhjäksi jos haluat listata kaikki saatavat").".</td></tr>";
	echo "</form>";
	echo "</table><br>";
