<?php
	...
	if ($del == 1) {
		...
		// Jos poistamme ifamesta tietoja niin p‰ivitet‰‰n varsinaisen tietueen updated_at, jotta verkkokauppasiirto huomaa, ett‰ tietoja on muutettu
		if ($lukitse_avaimeen != "") {
	...
	if ($upd == 1) {
		...
		if ($errori == "") {
			...
			// Jos p‰ivit‰mme ifamesta tietoja niin p‰ivitet‰‰n varsinaisen tietueen updated_at, jotta verkkokauppasiirto huomaa, ett‰ tietoja on muutettu
