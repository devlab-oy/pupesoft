...
echo "<font class='head'>".t("Saapuva tavaraer‰")."</font><hr>";
...
if ($toiminto == "poista") {
	...
	if ($eisaapoistaa == 0) {
		...
		$komm = "(" . $kukarow['kuka'] . "@" . date('Y-m-d') .") Mit‰tˆitiin ohjelmassa saapuminen.php<br>";
...
if ($toiminto == "" and $ytunnus == "" and $keikka == "") {
	...
	echo "</tr>";
	echo "<tr>";
	echo "<th>".t("Etsi saapumis-/tilausnumero")."</th>";
