...
if ((isset($ppalku) and trim($ppalku) == '') or (isset($kkalku) and trim($kkalku) == '') or (isset($vvalku) and trim($vvalku) == '')) {
  echo "<font class='error'>",t("VIRHE: Alkupäivämäärä on virheellinen"),"!</font><br /><br />";
  $tee = "";
}

if ((isset($pploppu) and trim($pploppu) == '') or (isset($kkloppu) and trim($kkloppu) == '') or (isset($vvloppu) and trim($vvloppu) == '')) {
  echo "<font class='error'>",t("VIRHE: Loppupäivämäärä on virheellinen"),"!</font><br /><br />";
  $tee = "";
}
...
echo "<tr><th>",t("Päivämäärä"),"</th><td style='text-align:right; vertical-align:middle;'>";
