...
if ($toiminto == 'LINKKAA') {
  ...
  echo "pit‰s updatee laitteiden_sopimukset ja lopuks unsettaa muuttujat<br>";
...
elseif ($toiminto == 'UUSILAITE') {
  ...
  // Sopimukset 1/2
  // Haetaan sarjanumerot jotka eiv‰t ole jo laitteissa
  ...
  if ($toiminto == 'LINKKAA') {
    ...
    echo "<input type='submit' name='paivita_sopimuksen_laitteet' value='P‰ivit‰ sopimuksen laitteet' />";
  }
  else {
    echo "<input type='hidden' name='toiminto' value ='UUSILAITE' />";
