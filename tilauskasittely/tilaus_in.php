...
if (move_uploaded_file($_FILES['userfile']['tmp_name'], $filename)) {
  ...
  if ($path_parts["extension"] != "" and strtoupper($path_parts["extension"]) != "TXT") {
    echo "<font class='error'>".t("Tiedosto")." $filename ".t("ei tunnu aineistolta")."!<br>".t("Pitää olla .txt (nyt")." $path_parts[extension]).<br>".t("Tarkista tiedosto")."!<br></font>";
    exit;
  }
  ...
  echo "<font class='head'>".t("Tilausten sisäänluku")."</font><hr>";
