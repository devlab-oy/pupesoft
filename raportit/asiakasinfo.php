		...
		if ($asale!='' or $aletaulu!='' or $yhdistetty != "" or $tee == "eposti") {
			...
			$query = "
						...
						(							
							...
							JOIN tuote ON tuote.yhtio=asiakasalennus.yhtio and tuote.tuoteno=asiakasalennus.tuoteno and hinnastoon != 'E' and status != 'P'
			...
			while ($asrow = mysql_fetch_array($asres)) {
				...
				if((($kukarow["extranet"] != "" or $tee == "eposti"  or $yhdistetty != "" or $rajattunakyma == "JOO") and ($edtry != $asrow["try"] or $edryhma != $asrow["alennusryhm‰"] or $edtuoteno != $asrow["tuoteno"])) or ($kukarow["extranet"] == "" and $tee != "eposti" and $yhdistetty == ""  and $rajattunakyma != "JOO")) {
