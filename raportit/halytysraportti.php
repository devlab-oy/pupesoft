  ...
  if (mysql_num_rows($res) > 0) {
    ...
    while ($row = mysql_fetch_assoc($res)) {
      ...
      $query = "SELECT
                ...
                sum(if (tilausrivi.laskutettuaika >= '$vva1-$kka1-$ppa1' and tilausrivi.laskutettuaika <= '$vvl1-$kkl1-$ppl1' and tilausrivi.kampanja > 0 ,tilausrivi.rivihinta,0)) kampanja1,
