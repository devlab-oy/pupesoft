...
if (!$php_cli) {
  ...
  echo "<tr>";
  echo "<th>", t("N‰yt‰ tuotepaikkakohtainen h‰lytysraja raportilla"), ":</th>";
...
if (isset($supertee) and $supertee == "RAPORTOI") {
  ...
  if (isset($nayta_halyraja) and isset($summaustaso) and $summaustaso != "P") {
    echo "<font class='error'>", t("Huom. Otettaessa tuotepaikkakohtainen h‰lytysraja raportille, tulee summaustason olla: Varastonarvo varastopaikoittain"), "!</font><br/>";
  }
  ...
  if (isset($nayta_halyraja) and $summaustaso == "P") {
    if ($tallennusmuoto_check) {
      $worksheet->writeString($excelrivi, $excelsarake, t("H‰lytysraja"), $format_bold);
      $excelsarake++;
    }
    else {
      fwrite($fh, pupesoft_csvstring(t("H‰lytysraja"))."\t");
    }
  }
