<?php
	...
	if ($tee == "W") {
		...
		if ($thyllyalue == "" or $thyllynro == "" or $thyllyvali == "" or $thyllytaso == "") {
			echo "<font class='error'>VIRHE: Syˆtetty varastopaikka ei ollut t‰ydellinen</font><br>";
			$tee = "V";
		}

		if (kuuluukovarastoon($thyllyalue, $thyllynro) == 0) {
			echo "<font class='error'>VIRHE: Syˆtetty varastopaikka ei kuulu mihink‰‰n varastoon ($ahyllyalue-$ahyllynro)</font><br>";
			$tee = "V";
		}
