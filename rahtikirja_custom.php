...
<?php
	echo "<tr><th>L‰hett‰j‰n viite</th><td><input type=hidden name='asiakas' value='{$asiakasrow['ytunnus']}'><input type='text' name='viitelah'></td></tr>";
