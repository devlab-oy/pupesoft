...
if ($tee != '' and isset($painoinnappia)) {
  ...
  echo "<th nowrap>".t("Tuoteryhmä")."</th>";
  echo "<th nowrap>".t("Myynti")."<br>".t("aikavälillä")."<br>$vvl</th>";
  echo "<th nowrap>".t("Kate")."<br>".t("aikavälillä")."<br>$vvl</th>";
  echo "<th nowrap>".t("Kate %")."<br>".t("aikavälillä")."<br>$vvl</th>";
  echo "<th nowrap>".t("Myynti")."<br>".t("aikavälillä")."<br>$edellisvuosi</th>";
  echo "<th nowrap>".t("Kate")."<br>".t("aikavälillä")."<br>$edellisvuosi</th>";
  echo "<th nowrap>".t("Kate %")."<br>".t("aikavälillä")."<br>$edellisvuosi</th>";
