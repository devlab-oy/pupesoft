...
// Katsotaan, että tilaus on vielä samassa tilassa joss se oli kun klikattiin auki muokkaatilaus-ohjelmassa
// if ($tee == 'AKTIVOI') {
// 	echo "AKTIVOI 1.<br>";

// 	# TODO: Tätä $mista tsekkia ei enää välttämättä tarvita?
// 	# if ($mista == "muokkaatilaus") {
// 		// Onko tilauksen tila muuttunut
// 		if ( ! tarkista_tilauksen_tila($tilausnumero, $orig_tila, $orig_alatila)) {
// 			echo "<font class='error'>" . t("Tilauksen tila on vaihtunut. Ole hyvä ja avaa tilaus uudestaan") . "</font><br>";
// 			exit();
// 		}
// 	# }
// }
