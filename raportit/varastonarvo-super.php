...
if (isset($supertee) and $supertee == "RAPORTOI" or ($php_cli and $argv[0] == 'varastonarvo-super.php' and $argv[1] != '')) {
  ...
  if ($tallennusmuoto_check) {
    ...
    fwrite($fh, t("Osasto").";".t("Tuoteryhm‰").";".t("Tuoteno").";".t("Nimitys").";".t("Yksikko").";");
  }
  ...
  if ($variaatiosummaus == "") {
    ...
    if ($tallennusmuoto_check) {
      ...
      fwrite($fh, t("Ep‰kurantti 25%").";");
      fwrite($fh, t("Ep‰kurantti 50%").";");
      fwrite($fh, t("Ep‰kurantti 75%").";");
      fwrite($fh, t("Ep‰kurantti 100%").";");
      fwrite($fh, t("Viimeinen hankintap‰iv‰").";");
    }
  }
