...
function hae_asiakasryhmadata($limitti = " LIMIT 10 ") {
  ...
  while ($row = mysql_fetch_assoc($result)) {
    $osre = t_avainsana("ASIAKASRYHMA", "", "and avainsana.selite  = '{$row['asiakasryhm‰']}'", "'{$kukarow['yhtio']}'");
