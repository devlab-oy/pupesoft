...
if ($submit_button != '' and ($lisa != '' or $lisa_parametri != '')) {
  ...
  if (mysql_num_rows($result) > 0) {
    ...
    if ($verkkokauppa == "") {
      ...
      // Ext-ennakolla kun asiakas lisää rivejä ei ole tarpeellista näyttää myytävissä-saraketta
        ...
        elseif ($kukarow["extranet"] != "" or $verkkokauppa != "") {
          ...
          if ($myytavissa > 0 or $noutolisa != "") {
            if ($verkkokauppa != "" and $verkkokauppa_saldoluku) {
              ...
              echo ($hinta_rajaus != "" and $myytavissa > 0) ? "<font class='green'>".t("Päävarasto").": ".t("On")."</font>": "<font class='green'>".t("On")."</font>";
            }
          }
          elseif ($row['status'] != 'T') {
