<?php
	...
	if ($tee != "" and $tee != "MUUOTAOSTIKKOA") {
		...
		if ($tee == 'TI' and $tuoteno != "") {
			//Jos radio-button: Tuotenumerot on tuotteentoimittajat tuotenumerot -asennossa, lis‰t‰‰n $tuoteno eteen kysymysmerkki. T‰llˆin j‰rjestelm‰ hakee toimittajan tuotenumeron perusteella.
