		...
		if ($rivilaskuri != 0) {
			...
			while ($row = mysql_fetch_array($result)) {
				...
				elseif ($row["var"] == "J") {
					...
					//Jos toimittajan maakoodi on tyhj‰ niin k‰ytet‰‰n yhtiˆn maakoodia
					if (trim($srow2["maa"]) == "") {
			...
			echo "<tr>
				<td class='back' colspan='$ycspan'></td>
				<th colspan='4' align='right'>".t("Tilaus yhteens‰").":</th>
			...
			if ($laskurow['erikoisale'] > 0 and $kukarow['hinnat'] != 1) {
				...
				if ($kukarow['extranet'] == '' and $ulkomaa_kaikkiyhteensa != 0) {
					echo "<tr>
						<td class='back' colspan='$ycspan'></td>
						<th colspan='4' align='right'>".t("Yhteens‰ kotimaa").":</th>
					...
					echo "<tr>
						<td class='back' colspan='$ycspan' align='right'>$ulkom_huom</td>
						<th colspan='4' align='right'>".t("Yhteens‰ ulkomaa").":</th>
				...
				echo "<tr>
					<td class='back' colspan='$ycspan'></td>
					<th colspan='4' align='right'>".t("Yhteens‰").":</th>
			...
			if ($kukarow["extranet"] == "" and ($kukarow['kassamyyja'] != '' or $toim == "TARJOUS")) {
				...
				echo "	<form name='pyorista' action='$PHP_SELF' method='post' autocomplete='off'>
						...
						<th colspan='4'>".t("Pyˆrist‰ loppusummaa").":</th>
