...
while($row = mysql_fetch_assoc($result)) {
	...
	# TODO: listaus päivitettävä nykyisillä oletuspaikoilla
	...
	# Linkki eteenpäin vahvista_keräyspaikka näkymään.
	# Ainakin tälle tulleet parametrit, viivakoodi, tuotenumero ja ostotilaus.

	# Pakolliset tiedot vahvista_keräyspaikka näkymälle
	# $tilausrivi
	# Tän parametrit riippuu millä tähän sivulle on tultu?
