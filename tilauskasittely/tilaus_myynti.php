...
if ($tee == "VALMIS" and ($muokkauslukko == "" or $toim == "PROJEKTI")) {
	...
	// Myyntitilaus valmis
		...
		if ($asiakas_luottoraja == 0 ) {
			...
			// varaa_ostaa_tavaraa on saldo joka on käytettävissä asiakkaan tilaukselle/tilauksille.
			...
			if ($varaa_ostaa_tavaraa >= $laskun_summa) {
				...
				echo "<p class='error'>".t("Laskun ja avoimien laskujen yhteissumma ylittää käytettävissä olevan luoton määrän")."</p>";
				if ($toim == "EXTRANET") {
					echo "<p class='error'>".t("Ota tarvittaessa yhteyttä Asiakaspalveluun")."</p>";
				}
