...
if ($tee == 'U') {
  ...
  if ($erittely == '') {
    ...
    if (($nimitieto=="LUOTTOKUNTA-KREDITLAGET") or ($nimitieto=="LUOTTOKUNTA") or ($nimitieto=="LUOTTOKUNTA/VISA") or ($nimitieto=="LUOTTOKUNTA OY") or ($nimitieto=="NETS OY") or ($nimitieto=="NETS DENMARK A/S FILIAL I FINLAND") or ($nimitieto=="NETS DENMARK AS FILIAL I FINLAND")) {
      ...
      if ($tilino2 != 0) {
        $virhe.= t("Vain maksajalle LUOTTOKUNTA-KREDITLAGET tai LUOTTOKUNTA tai LUOTTOKUNTA/VISA tai NETS OY tai NETS DENMARK A/S FILIAL I FINLAND voi antaa palkkiotilin tai NETS DENMARK AS FILIAL I FINLAND")."<br>";
        $ok = 1;
        $tee = '';
      }
      if ($kustp2 != 0) {
