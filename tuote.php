...
echo "<script type='text/javascript'>
        $(function() {
          ...
          $('#raportointi').on('click', function() {
            ...
            var raportointi_tyyppi = $('.raportti_tyyppi:checked').val();
  ...
  if ($tuoterow["tuoteno"] != "") {
    ...
    if ($toim != "TYOMAARAYS_ASENTAJA") {
      ...
      echo "<form action='$PHP_SELF#Raportit' method='post'>
        ...
        (<input type='radio' class='raportti_tyyppi' onclick='submit()' name='raportti' value='MYYNTI' $sele[M]> ".t("Myynnist‰")." /
