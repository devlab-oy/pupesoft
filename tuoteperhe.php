  ...
  if (mysql_num_rows($result) == 1) {
    ...
    elseif (mysql_num_rows($result) == 1) {
      ...
      if ($toim == "PERHE") {
        ...
        #echo "<th>".t("Rivikommentti")."</th>";
        echo "<th>".t("Kehahin")."</th><th>".t("Kehahin*Kerroin")."</th><th>".t("Ohita keräys")."</th><th>".t("Ei näytetä")."</th><td class='back'></td></tr>";
      ...
      while ($prow = mysql_fetch_array($res)) {
        ...
        if ($tunnus != $prow["tunnus"]) {
          ...
          if ($toim == "PERHE") {
            ...
            $chk_ei_nayteta = (isset($prow['ei_nayteta']) and trim($prow['ei_nayteta']) != '') ? t("Ei näytetä") : t("Näytetään");
