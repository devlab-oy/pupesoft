<?php
	...
	echo "<th nowrap><a href='$PHP_SELF?tee=OSASTOTRYYHTEENVETO&luokka=$luokka&try=$try&osasto=$osasto&order=try&sort=asc$ulisa'>".t("Piiri")."</a><br>&nbsp;</th>";
	...
	echo "<th nowrap><a href='$PHP_SELF?tee=OSASTOTRYYHTEENVETO&luokka=$luokka&try=$try&osasto=$osasto&order=tuotelkm&sort=desc$ulisa'>".t("Asiakkaita")."<br>".t("KPL")."</a></th>";
