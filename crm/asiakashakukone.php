...
if($tee == "") {
	...
	if($hakupalkki != "OHI") {
		...
		echo "</select><br>".t("Piireitt‰in").": <input type='checkbox' name='group[piiri]' value='checked' {$group["piiri"]}> prio: <input type='text' name='prio[piiri]' value='{$prio["piiri"]}' size='2'></td>";
		...
		echo "</select><br>".t("Ryhmitt‰in").": <input type='checkbox' name='group[asiakasryhma]' value='checked' {$group["asiakasryhma"]}> prio: <input type='text' name='prio[asiakasryhma]' value='{$prio["asiakasryhma"]}' size='2'></td>";
