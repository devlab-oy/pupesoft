...
if ($tee == 'TEEVALMISTUS') {
  ...
  // Laiteaan rivit j‰rjestykseen, ensin pit‰‰ valmistaa toisten raaka-aineeksi tarvittavat tuotteet
...
if ($tee == 'TEEVALMISTUS') {
  ...
  if ($tee == "TEEVALMISTUS") {
    if ($toim == "KORJAA") {
      ...
      // Laiteaan rivi j‰rjestykseen, ensin pit‰‰ valmistaa toisten raaka-aineeksi tarvittavat tuotteet
...
if (!isset($from_kaikkikorj)) {
  ...
  if ($tee == "VALMISTA" and $valmistettavat != "") {
    ...
    if ($toim != 'KORJAA') {
      ...
      echo "<input type='submit' name='' value='".t("ƒl‰ korjaa")."' onclick='lisatiedot();'>";
    }
    echo "</form>";
  }
