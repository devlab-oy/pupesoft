...
echo "<tr><th>".t("Listaa tuotteet joilla poikkeamaprosentti on vähintään")."</th>
    <td colspan='3'><input type='text' size='15' name='prosmuutos' value='$prosmuutos' size='3'> ".t("prosenttia")."</td><td class='back'>".t("Lisätyt tuotteet + merkillä ja vähennetyt tuotteet - merkillä, tai absoluuttinen.")."</td></tr>";

echo "<tr><th>".t("Listaa tuotteet joiden kappalemäärä on muuttunut vähintään")."</th>
