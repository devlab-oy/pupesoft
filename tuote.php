...
=======
	...
	if ($tee == 'Z') {
		...
		if ($tuoterow["tuoteno"] != "") {
			...
			// aika karseeta, mutta katotaan voidaanko t‰ll‰st‰ optiota n‰ytt‰‰ yks tosi firma specific juttu
			if (table_exists("yhteensopivuus_tuote") and file_exists("yhteensopivuus_tuote.php") and tarkista_oikeus('yhteensopivuus_tuote.php')) {
>>>>>>> 7e2bbb8c0b2843f92b9e1b2add25265ef4ca2943
...
<<<<<<< HEAD
      ...
      if ($tuoterow["ei_saldoa"] == '') {
        ...
        if (mysql_num_rows($sresult) > 0) {
          while ($saldorow = mysql_fetch_assoc ($sresult)) {
            ...
            list($saldo, $hyllyssa, $myytavissa) = saldo_myytavissa($saldorow["tuoteno"], '', '', $saldorow["yhtio"], $saldorow["hyllyalue"], $saldorow["hyllynro"], $saldorow["hyllyvali"], $saldorow["hyllytaso"], '', $saldoaikalisa, $era);
            ...
            echo "<tr>";
            echo "<td>$saldorow[nimitys] $saldorow[tyyppi] $era</td>";
      ...
      if ($toim != "TYOMAARAYS_ASENTAJA") {
        ...
        if ($tapahtumalaji == "laskutus")       	{$sel1="SELECTED";}else{$sel1="";}
        if ($tapahtumalaji == "tulo")         		{$sel2="SELECTED";}else{$sel2="";}
        if ($tapahtumalaji == "valmistus")        	{$sel3="SELECTED";}else{$sel3="";}
        if ($tapahtumalaji == "siirto")         	{$sel4="SELECTED";}else{$sel4="";}
        if ($tapahtumalaji == "kulutus")          	{$sel5="SELECTED";}else{$sel5="";}
        if ($tapahtumalaji == "Inventointi")      	{$sel6="SELECTED";}else{$sel6="";}
        if ($tapahtumalaji == "Ep‰kurantti")      	{$sel7="SELECTED";}else{$sel7="";}
        if ($tapahtumalaji == "poistettupaikka")  	{$sel8="SELECTED";}else{$sel8="";}
        if ($tapahtumalaji == "uusipaikka")       	{$sel9="SELECTED";}else{$sel9="";}
        ...
        if ($tuoterow["ei_saldoa"] == "") {
          ...
          echo "<td align='right'>".sprintf('%.2f', $_kehahin)."</td>";
        ...
        while ($prow = mysql_fetch_assoc ($qresult)) {
          ...
          if ($tapahtumalaji == "" or strtoupper($tapahtumalaji)==strtoupper($prow["laji"])) {
            ...
            echo "<td nowrap align='right' valign='top'>".sprintf('%.2f', $_hinta)."</td>";

            if ($prow["laji"] == "laskutus") {
              $kate = kate_kuluineen($prow['tuoteno'], $prow['rivihinta'], $prow['kate']);
