  ...
  while (($file = readdir($handle)) !== FALSE) {
    if (is_file($ftpget_dest[$operaattori]."/".$file)) {
      ...
      foreach ($otunnukset_arr as $key => $otunnukset) {
        ...
        pupesoft_log('toimitusvahvistus_email', "Ollaan menossa toimitusvahvistuksen lähetykseen? ({$laskurow['toimitusvahvistus']})");
        ...
        if ($laskurow['toimitusvahvistus'] != '' and !$_desadv) {
          ...
          if (file_exists("tilauskasittely/{$laskurow['toimitusvahvistus']}")) {
            ...
            pupesoft_log('toimitusvahvistus_email', "Päästiin reuire-iffistä läpi ({$laskurow['toimitusvahvistus']})");
