<?php
	...
	if ($row["kuka"] == $kukarow["kuka"]) {
		...
		if($row[1] == "Sauna") {
			...
			$tulos = mail("$yhtiorow[varauskalenteri_email]", "Saunavarauksen peruutus", $meili, "From: ".mb_encode_mimeheader($kukarow["nimi"])." <".$kukarow["eposti"].">\nReply-To: ".mb_encode_mimeheader($kukarow["nimi"])." <".$row["eposti"].">\n", "-f $yhtiorow[postittaja_email]");
		}
	}
	else {
