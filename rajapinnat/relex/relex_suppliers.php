...
$filepath = "/tmp/supplier_update_{$yhtio}_{$ajotext}{$ajopaiva}.csv";
...
echo date("d.m.Y @ G:i:s") . ": Relex Toimittajarivej‰ {$rows} kappaletta.\n";
...
echo date("d.m.Y @ G:i:s") . ": Relext toimittajat valmis.\n\n";
