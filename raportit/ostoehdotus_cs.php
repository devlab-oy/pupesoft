	...
	if ($tee == "RAPORTOI" and isset($ehdotusnappi)) {
		...
		while ($row = mysql_fetch_assoc($res)) {
			...
			if ($toim == "KK") {
				...
				// Vähennetään vapaasta saldosta varastosta lähteneet keskeneräiset varastosiirrot
				if (isset($varastosta[$row['tuoteno']])) {
					$vapaasaldo -= $varastosta[$row['tuoteno']];
				}

				// Lisätään vapaaseen saldoon varastoon matkalla olevat keskeneräiset varastosiirrot
